...
entry=df["Theoretical Performance FP16 (half) performance"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Theoretical Performance FP32 (float) performance"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Theoretical Performance FP64 (double) performance"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Theoretical Performance Pixel Rate"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Theoretical Performance Texture Rate"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Graphics Processor Transistors"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Memory Bandwidth"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Graphics Processor Die Size"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Board Design TDP"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Graphics Card Release Date"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
    ...
    value=float(entry_parts[0].replace(",", ""))
    unit=entry_parts[-1]
print("Graphics Card Release Date: '{}' : value={} unit={}".format(entry, value, unit))
entry=df["Graphics Card Launch Price"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
...
entry=df["Graphics Processor Process Size"].iloc[1203]
if ( pd.isnull(entry) ):
    value=entry
    unit=""
else:
